<?php 
 ...
 <body id="body2">
  <?php include '../navbar/nav.php' ?>
    ...
    <?php endif ?>
  <div class="container mt-3 pt-3 pb-3 rounded" style="background: rgba(0,0,0,0.5);">
    <div class="row">
            ...
            <div class="col-8 pt-5 pb-5 " style="margin-left: 50px">
                <div class="row">
                    <div class="col-4 fw-light">
                        <h3 class="fw-light border-bottom">Nama</h3>
                        <h3 class="fw-light mt-1 border-bottom"><?php if ($row["id_role"]) {
                            echo "Wali Kelas";
                        }elseif($row["id_role"]){
                            echo "Kelas";
                        } ?></h3>
